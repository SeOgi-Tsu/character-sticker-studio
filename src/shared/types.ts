...
export interface PersonaPreset { id: string; name: string; description: string; brief: string; }
...
export interface Job {
  ...
  remoteTaskId?: string;
  textMode?: TextMode; generatedText?: string;
}
...
export interface Catalog { reactions: Reaction[]; styles: Style[]; packs: Pack[]; sources: Source[]; compositions: Composition[]; interactions: Interaction[]; captionStyles: CaptionStyle[]; personas: PersonaPreset[]; }
